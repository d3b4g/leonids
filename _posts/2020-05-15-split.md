...
Combine elements from the ret2win challenge that have been split apart to beat this challenge. Learn how to use another tool whilst crafting a short ROP chain. Your can get the binary for this challenge from ROPGadget [here] (https://ropemporium.com/) 

###### Tools Used:


+ ROPGadget [Download](https://github.com/JonathanSalwan/ROPgadget)
+ Pwntools  [Download](https://github.com/Gallopsled/pwntools)
+ Radare2   [Download](https://rada.re/n/)
+ DBG & gef [Download](https://github.com/hugsy/gef)
...
Copy the value in RSP to gef pattern offset tool.
```
...
Lets find the building blocks we need to build a ROP chain.
...
Now we have everything we need to put together our ROPChain, let’s craft the payload.
